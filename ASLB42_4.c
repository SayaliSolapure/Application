...
int DisplayAll(int Arr[], int Brr[], int iLength1, int iLength2)
{
    int iCnt = 0;
    int iSum;

    for(iCnt = 0; iCnt < iLength1 && iCnt < iLength2; iCnt++)
    {
        iSum = (Arr[iCnt],Brr[iCnt]);
        printf("%d\t",iSum);
    }
}
...
int main()
{
    ...
    DisplayAll(ptr1, ptr2, iSize1, iSize2);
