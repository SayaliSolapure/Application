...
void man(char *name)
{
    ...
    else if(strcmp(name,"lseek") == 0)
    {
        ...
        printf("Usage : lseek File_Name ChangeIn Offset StartPoint\n");
    }
...
int WriteFile(int fd, char *arr, int isize)
{
    ...
    if((UFDTArr[fd].ptrfiletable->ptrinode->Buffer) + (UFDTArr[fd].ptrfiletable->writeoffset),arr,isize);
...
int fstat_file(int fd)
{
    ...
    printf("\n__________Statistical Information about file__________\n");
    printf("File name : %s\n",temp->FileName);
